...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transData[1].name = "腳踏車";
        transData[2].name = "腳踏車";
        transData[3].name = "腳踏車";
        ...
        myAdapter transAdapter = new myAdapter(transData,R.layout.list2);

        Spinner spinner = (Spinner) findViewById(R.id.spinner);
        spinner.setAdapter(transAdapter);

        String[] messageData = new String[]{"m1","m2","m3","m4","m5","m6"};
        ...
        myAdapter cubeeAdapter = new myAdapter(cubeeData,R.layout.list);
        GridView giidView = (GridView) findViewById(R.id.GridView);
        giidView.setNumColumns(3);
        giidView.setAdapter(cubeeAdapter);
    }
